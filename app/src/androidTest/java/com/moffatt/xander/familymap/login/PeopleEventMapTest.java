...
/**
 * Tests mapping people to events
 * Created by Xander on 7/28/2016.
 */
public class PeopleEventMapTest extends InstrumentationTestCase{
    ...
    @Test
    public void testMapPeopleToEvents() throws Throwable {
    ...
    public class TestCallback implements LoginProxy {
        ...
        public void onRequestResponse(RequestResponse response) {
            ...
            if (currentRequest == LoginFragment.REQUEST_TYPE.AUTH) {
                ...
                currentRequest = LoginFragment.REQUEST_TYPE.PEOPLE;
                requestController.getAllPeople(authToken, testProxy);
            }
            else if (currentRequest == LoginFragment.REQUEST_TYPE.PEOPLE) {
                requestController.populateModelWithPersons((String) responseData);
                ...
                Map<String, ArrayList<Event>> map = FamilyReunion.getInstance().getPersonIDToEvents();
