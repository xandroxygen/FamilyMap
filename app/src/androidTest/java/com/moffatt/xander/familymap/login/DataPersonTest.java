...
/**
 * Tests getting all people
 * Created by Xander on 7/28/2016.
 */
public class DataPersonTest extends InstrumentationTestCase {
    ...
    @Test
    public void testGetPeople() throws Throwable {
    ...
    public class TestCallback implements LoginProxy {
        ...
        public void onRequestResponse(RequestResponse response) {
            ...
            if (currentRequest == LoginFragment.REQUEST_TYPE.AUTH) {
                ...
                ArrayList<Person> persons = FamilyReunion.getInstance().getPeople();
                assertEquals(63, persons.size());
                signal.countDown();
            }
        }
    }
